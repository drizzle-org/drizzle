defmodule Drizzle.WifiWizardButton do
  use GenServer

  @moduledoc """
  This GenServer starts the wifi wizard if a button is depressed for long enough.
  """
  ...
  def handle_info(:timeout, state) do
    IO.puts "VintageNetWizard triggered from pin #{state.pin}"
